<?php
/**
 * The template for displaying software category taxonomy archive pages
 *
                    ...
                    <div class="card_wrap">
                        ...
                        <div class="card_header">
                            ...
                            <div class="card_info">
                                ...
                                <!-- Category -->
                                <span class="card_category" style="color:var(--text-primary);"><?php echo esc_html($current_cat->name); ?></span>
                            </div>
                        </div>
