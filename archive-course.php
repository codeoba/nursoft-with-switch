<?php
/**
 * The template for displaying Course post type archives
 *
    ...
    <div class="software_layout">
        ...
        <div class="section-header" style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 20px; border-bottom: 1px solid var(--border-color); padding-bottom: 15px;">
            <div>
                ...
                <span style="font-size: 13px; color: var(--text-secondary);"><?php _e('Explore Professional Video Courses', 'nursoft'); ?></span>
            </div>
        ...
        <?php else : ?>
            <p style="text-align: center; color: var(--text-secondary); margin: 60px 0;"><?php _e('No courses found in this archive.', 'nursoft'); ?></p>
        <?php endif; ?>
            </section>
        </div>
