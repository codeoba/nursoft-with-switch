...
function nursoft_scripts() {
    ...
    wp_enqueue_style( 'nursoft-style', get_stylesheet_uri(), array( 'nursoft-fonts' ), '1.9.3' );

    // Enqueue Live Search JS
    wp_enqueue_script( 'nursoft-live-search', get_template_directory_uri() . '/assets/js/live-search.js', array(), '1.9.3', true );
    ...
    wp_enqueue_script( 'nursoft-download-handler', get_template_directory_uri() . '/assets/js/download-handler.js', array(), '1.9.3', true );
    wp_localize_script( 'nursoft-download-handler', 'nursoftDownload', array(
        'ajaxurl' => admin_url( 'admin-ajax.php' )
    ) );

    // Enqueue Quick View JS
    wp_enqueue_script( 'nursoft-quick-view', get_template_directory_uri() . '/assets/js/quick-view.js', array(), '1.9.3', true );
