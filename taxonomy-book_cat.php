<?php
/**
 * The template for displaying Book taxonomy Category archive pages
 *
    ...
    <div class="software_layout">
        ...
        <div class="section-header" style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 20px; border-bottom: 1px solid var(--border-color); padding-bottom: 15px;">
            <div>
                ...
                <span style="font-size: 13px; color: var(--text-secondary);"><?php echo $current_cat->count; ?> <?php _e('books available', 'nursoft'); ?></span>
            </div>
        ...
        <?php else : ?>
            <p style="text-align: center; color: var(--text-secondary); margin: 60px 0;"><?php _e('No books found in this category.', 'nursoft'); ?></p>
        <?php endif; ?>
            </section>
        </div>
